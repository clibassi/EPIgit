...
list COA tuitval9 grant9 ws9 loan9 needstata maxefc FedProratedEFC ProfileEFC if abs(COA-tuitval9)>1 & !missing(tuitval9) 
...
*/
gen ws10 = 2500 
replace ws10 = 0 if FedProratedEFC>2500
...
*Check to see this is equal to COA 
count if abs(COA-tuitval10)>1 & !missing(tuitval8) 
list COA tuitval10 grant10 ws10 loan10 needstata maxefc studentcost10 FedProratedEFC ProfileEFC if abs(COA-tuitval10)>1 & !missing(tuitval10) 
