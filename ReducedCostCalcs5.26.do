...
/**Create work study calculation so that work study is 2500
   ...
   to 0:
*/
gen ws11 = COA-grant11-FedProratedEFC
label variable ws11 "Amount of Federal Work Study - New Program" 
replace ws11 = 0 if ws11<0
...
gen studentcost11 = COA-(grant11+ws11+loan11)
**************
* Cost Calcs *
**************
...
egen totcost1112fi100 = total(costdif910) if freered11==1 & freered12==1 & faminc<100000

*Fam Inc in the bottom quartile
egen totcost1112fibq = total(costdif910) if freered11==1 & freered12==1 & faminc<66225

*Family Investment (any at all)
egen totcost1112inwany = total(costdif910) if freered11==1 & freered12==1 & ParentInvNetWorth==0 & !missing(ParentInvNetWorth)

*Family Investment (in top quartile) 
egen totcost1112inwtq = total(costdif910) if freered11==1 & freered12==1 & ParentInvNetWorth<96000 & !missing(ParentInvNetWorth)

*Fam Inc in the bottom quartile & No Investments 
egen totcost1112fibqni = total(costdif910) if freered11==1 & freered12==1 & faminc<66225 & ParentInvNetWorth==0

*Fam Inc in the bottom quartile & No Investments 
egen totcost1112fibqinwtq = total(costdif910) if freered11==1 & faminc<66225 & ParentInvNetWorth==0 & ParentInvNetWorth<96000
...
summ maxefc FedProratedEFC costdif911 if  freered11==1 & freered12==1
summ maxefc FedProratedEFC costdif911 if freered11==1 & freered12==1 & faminc<100000
summ maxefc FedProratedEFC costdif911 if freered11==1 & freered12==1 & faminc<66225
summ maxefc FedProratedEFC costdif911 if freered11==1 & freered12==1 & ParentInvNetWorth<96000
summ maxefc FedProratedEFC costdif911 if freered11==1 & freered12==1 & ParentInvNetWorth==0
summ maxefc FedProratedEFC costdif911 if freered11==1 & freered12==1 & faminc<66225 & ParentInvNetWorth<96000
summ maxefc FedProratedEFC costdif911 if freered11==1 & freered12==1 & faminc<66225 & ParentInvNetWorth==0
